...
@section('content')
	...
	<h2 class="page-header">Quản lý sản phẩm <a class="thao-tac them label label-primary float-right" href="{{ route('admin.get.create.article') }}" title="Thêm mới">
			...
			<span style="display: none">{{ $a=1 }}</span>
				@foreach($articles as $article)
					<tr>
						...
						<td>
							<img src="{{ asset(pare_url_file($article->a_avatar)) }}" alt="image" width="80px" height="80px">
						</td>
						...
						<td><!-- Thao tác -->
							<a class="thao-tac sua label label-primary" href="{{ route('admin.get.edit.article',$article->id) }}" title="Cập nhập">
								<i class="fa fa-pencil-square-o" aria-hidden="true"></i>Sửa
							</a>
							<a class="thao-tac xoa label label-danger" href="{{ route('admin.get.action.article',['delete', $article->id]) }}" title="Xóa">
